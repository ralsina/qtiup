 ...
 * $Id: treedef.h,v 1.12 2006/01/07 20:10:11 scuri Exp $
 */
...
struct Node_
{
 ...
 char image[NODE_SIZE] ;                       /* Node's image */ 
 ...
 char expandedimage[NODE_SIZE] ;               /* Node's image */ 
...
typedef struct _Ttree
{
  ...
  Ihandle  *canvash; /* Handle of tree */
  ...
  /* Treeview's images */ 
  char image_leaf[NODE_SIZE] ;  
  char image_collapsed[NODE_SIZE] ; 
  char image_expanded[NODE_SIZE] ;              
...
#define tree_canvash(_)  ((_)->canvash)
#define tree_cdh(_)      ((_)->cdh)
