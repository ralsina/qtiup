 ...
 * $Id: icb_hls.c,v 1.3 2003/06/17 19:43:50 scuri Exp $
 */
...
void hls_hplasma(int iw, int ih, int cl, uchar *ur, uchar *ug, uchar *ub)
{
  ...
  cdForeground(cdEncodeColor(shade_dr, shade_dg, shade_db));
  x1 = 0.0f; y1 = ih/2.0f; x2 = 6.0f; y2 = ih/2.0f;
  cdLine((int) x1, (int) y1, (int) x2, (int) y2);
  rot(&x1, &y1, &x2, &y2, ih);
  cdForeground(cdEncodeColor(shade_lr, shade_lg, shade_lb));
  cdLine((int) x1, (int) y1, (int) x2, (int) y2);
  rot(&x1, &y1, &x2, &y2, ih);
  cdForeground(cdEncodeColor(shade_dr, shade_dg, shade_db));
  cdLine((int) x1, (int) y1, (int) x2, (int) y2);
  ...
  /* desenha a borda */
  cdForeground(cdEncodeColor(shade_dr, shade_dg, shade_db));
  cdArc(iw/2, iw/2, iw, iw, 45.0, 225.0);
  cdForeground(cdEncodeColor(shade_lr, shade_lg, shade_lb));
  cdArc(iw/2, iw/2, iw, iw, 225.0, 45.0);

  cdForeground(cdEncodeColor(shade_lr, shade_lg, shade_lb));
  cdArc(iw/2, iw/2, iw-2*cl, iw-2*cl, 45.0, 225.0);
  cdForeground(cdEncodeColor(shade_dr, shade_dg, shade_db));
  cdArc(iw/2, iw/2, iw-2*cl, iw-2*cl, 225.0, 45.0);
