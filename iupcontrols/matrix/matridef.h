 ...
 * $Id: matridef.h,v 1.14 2006/02/03 21:51:29 uid20021 Exp $
 */
...
typedef struct _Tmat
{
   ...
   Ihandle  *canvash;   /* Handle da matrix              */
   ...
   cdCanvas *cdh;       /* Handle para uso do cd         */
   cdCanvas *cdh_buf;
   int redraw;
...
#define mat_canvash(_)  ((_)->canvash)
#define mat_cdh(_)      ((_)->cdh)
...
#define SetSbH  if(mat)                                                   \
                {                                                         \
                  ...
                  IupSetAttribute(mat_canvash(mat),IUP_DX  ,mat->sb_tamanhox); \
                  IupSetAttribute(mat_canvash(mat),IUP_POSX,mat->sb_posicaox); \
                }
...
#define SetSbV  if(mat)                                                   \
                {                                                         \
                  ...
                  IupSetAttribute(mat_canvash(mat),IUP_DY  ,mat->sb_tamanhoy); \
                  IupSetAttribute(mat_canvash(mat),IUP_POSY,mat->sb_posicaoy); \
                }
