 ...
 * $Id: itgetset.h,v 1.9 2006/03/24 01:39:47 scuri Exp $
 */
...
int treegetsetSetImage (char* name, char* image, unsigned long int* colors, unsigned long int* selected, int range, Node node);
