...
TList *AppendList ( TList *l, void *i )
{
 if ( l == NULL )
   return NULL;
...
TList *AddList ( TList *l, int n, void *info )
{
 int i;
...
int DelEntry ( TList *l, void *entry )
{
 int i=1;
 ...
 for (i=0; i< list_n(l); ++i)
  ...
  {
   DelList(l,i+1);              /* o usuario ve a lista iniciando em 1 e a */
                                /* lista e' implementada iniciando em 0     */
   return i+1;
  }
 return 0;
