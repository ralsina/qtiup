...
* $Id: icreate.c,v 1.18 2006/03/14 21:28:02 scuri Exp $
*/
...
Ihandle* IupColor (unsigned int r, unsigned int g, unsigned int b)
{
  ...
  type(n) = COLOR_;
  IupSetfAttribute(n,IUP_RED, "%u", r);
  IupSetfAttribute(n,IUP_GREEN,"%u", g);
  IupSetfAttribute(n,IUP_BLUE,"%u", b);
  return n;
}
