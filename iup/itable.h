 ...
 * $Id: itable.h,v 1.15 2006/01/19 22:03:20 scuri Exp $
 */
 ...
 */
  Itable *iupTableCreate2 (enum Itable_IndexTypes indexType,
...
*/
  void iupTableSet (Itable * n, const char *key, void *value,
...
*/
  void *iupTableGet2 (Itable * n, const char *key,
                      enum Itable_Types *itemType);
