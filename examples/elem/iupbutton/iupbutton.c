...
int main( void )
{
  ...
  /* Creates a button */
  btn_image = IupButton ( "Button with image", "ACTION" );       
  ...
  IupSetAttribute( btn_image, IUP_BUTTON_CB, "ACTION" ); 
